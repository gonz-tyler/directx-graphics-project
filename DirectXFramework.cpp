...
Vector3 DirectXFramework::GetCameraPosition()
{
	return _eyePosition;
}
...
/*std::shared_ptr<ResourceManager> DirectXFramework::GetResourceManager()
{
	if (_dxFramework)
	{
		return _dxFramework->_resourceManager;
	}
	else
	{
		// Handle the case where _dxFramework is not initialized
		return nullptr;
	}
}*/
