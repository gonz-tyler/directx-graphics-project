...
struct CBuffer
{
	...
	// Fields for point light
	//Vector4		PointLightPosition;
	//float		PointLightAttenuationA;
	//float		PointLightAttenuationB;
	//float		PointLightAttenuationC;

	// Fields for spot light
	//Vector4		SpotLightPosition;
	//Vector4		SpotLightDirection;
	//float		SpotLightInnerCosine; // Cosine of inner angle for spot light
	//float		SpotLightOuterCosine; // Cosine of outer angle for spot light
